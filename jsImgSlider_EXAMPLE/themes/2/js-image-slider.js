...
function mcImgSlider(k) {
  ...
  var c = "style",y = "display",G = "visibility",j = "width",z = "height",Y = "top",P = "background",r = "undefined",x = "marginLeft",w = "appendChild",q = "parentNode",o = "nodeName",Q = "innerHTML",X = "offsetWidth",D = setTimeout,L = clearTimeout,F = "indexOf",N = "setAttribute",jb = "removeChild",
    ...
    bb = sb() < 9,
    ib = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(
      navigator.userAgent
    ),
    M = function (a, b) {
      if (a) {
  ...
  E.prototype = {
    k: { c: k.transitionTime, a: function () {}, b: E.a.f, d: 1 },
    m: function (h, d, g, c) {
      for (
        var b = [],
          j = g - d,
  ...
  var l = new E(),
    ...
    qb = function (b) {
		// console.log(b + " estoy en la lineas 243");
      if (b == "series1")
    ...
    Cb = function (a) {
      return (
        a[q][h]("data-autovideo") == "true" || a[h]("data-autovideo") == "true"
      );
    },
    Eb = function () {
      var f;
  ...
  ub.prototype = {
    ...
    e: function (j) {
      ...
      if (a[o] != "IMG") {
        if (a[o] == "A")
          ...
          if (d) f = a[h]("data-alt") || "";
          a[h]("data-autovideo") &&
            a[q][N]("data-autovideo", a[h]("data-autovideo"));
          this.A(a[q]);
          i = 0;
        } else {
          d = a[h]("data-src");
    ...
    x: function () {
      for (
        var l = [], k = Math.round(v / a.g), i = Math.round(B / a.m), g = 0;
        g < a.m;
        g++
      )
        for (var f = 0; f < a.g; f++) {
